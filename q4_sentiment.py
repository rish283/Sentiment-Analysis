...
### YOUR CODE HERE
REGULARIZATION = np.logspace(-5,0.1,23)
...
### YOUR CODE HERE 
sort_res = sorted(results, key=lambda x: x['dev'],reverse=True)
BEST_REGULARIZATION = sort_res[0]['reg']
BEST_WEIGHTS = sort_res[0]['weights']
#raise NotImplementedError
### END YOUR CODE
