...
def forward_backward_prop(data, labels, params, dimensions):
    ...
    Z2 = np.dot(A1, W2) + b2 
    A2 = softmax(Z2)
    cost = - np.sum(np.log(A2[labels == 1]))/R
    ...
    gradb2 = gradb2/R 
    gradW2 = np.dot(A1.T, delta2)                   
    gradW2 = gradW2/R 
    delta1 = sigmoid_grad(A1) * np.dot(delta2, W2.T)
...
def sanity_check():
    ...
    #print params, 'paaaaaaaaraaaaaaaaaaaaaaaamssssssssssssssss'
